...
public class PracMPI {
    public static void main(String args[]) throws Exception {
         ...
         * MPI.COMM_WORLD.Gather(new double[]{localAvg}, 0, 1, MPI.DOUBLE, gathered, 0,
         * 1, MPI.DOUBLE, 0);
         * 
        ...
        // RECIPROCAL (2.4)
        /*
         * // create a recArr array that stores reciprocals of the elements of recv
         * array
         ...
         * MPI.COMM_WORLD.Gather(recArr, 0, chunkSize, MPI.DOUBLE, result, 0, chunkSize,
         * MPI.DOUBLE, 0);
         * 
 ...
 * 
 * 6. Compile Program
 * javac -cp .:$MPJ_HOME/lib/mpj.jar PracMPI.java
 * 
 * 9. Run Program
 * mpjrun.sh -np 4 PracMPI
 * 
 * 10. Output will display process-wise results.
 */